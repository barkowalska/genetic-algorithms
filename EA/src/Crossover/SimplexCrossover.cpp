...
std::vector<std::vector<double>> SimplexCrossover::cross(
  ...
  std::vector<std::vector<double>> expanded_vertices(n + 1,
...
SimplexCrossover::offsprings(const std::vector<std::vector<double>> &vertices) {
