...
/*
Creates offspring based on the centroid of parent vectors expanded by a user-defined factor.
*/
...
private:
    ...
    /*
        Creates offsprings inside the area created by parent+1 vertices, used inside cross
    Arguments:
