...
class BoltzmannTournamentSelection : public Selection<double>
{
    ...
    BoltzmannTournamentSelection(int k, double t): 
        m_tournamentSize(k), m_t(t){}

};

std::vector<size_t> BoltzmannTournamentSelection::selection(const std::vector<double> &fitnessValue)
{
